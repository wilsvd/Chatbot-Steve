...
QA_FILE = "./datasets/stanford/qa_data.json"
...
#     sm_dataset['question'] = sm_dataset['question'].apply(preprocess_text, stopwords=False, type='lemmatisation')
#     dump(sm_dataset, "./joblibs/sm_dataset.joblib")

def setup_intent_sm_dataset():
    intent_dataset = pd.read_csv(INTENT_FILE)
    intent_dataset['Utterances'] = intent_dataset['Utterances'].apply(preprocess_text, stopwords=False, type='lemmatisation')
